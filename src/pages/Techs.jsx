...
const Techs = () => {
  ...
  return (
    ...
    >
      <h1
        className={`text-[36px] 2xl:text-[64px] font-black ${
      ...
      >
        <div className="flex flex-col items-center">
          <span className="text-[#445964] font-medium text-[20px] 2xl:text-[24px]">
            Technologies
          </span>
          <h2 className="text-[28px] 2xl:text-[36px] font-black">
        ...
        <div className="flex gap-[30px] 2xl:gap-[100px]">
          <div className="w-[50px] h-[50px] 2xl:w-[106px] 2xl:h-[106px] hover:-translate-y-1 duration-200 cursor-pointer hover:translate-x-1 hover:scale-110">
